...
<template>
    <NuxtLink :to="{ path: `/projects/${project.id}`, hash: '#hero' }" v-motion-pop-visible-once class="group flex select-none flex-col items-center">
        <div
        ...
        >
            ...
            <img
                class="h-full w-full object-cover object-center transition-all duration-[.25s] ease-in-out group-hover:scale-110"
                :src="project.card.url"
                v-else-if="project.card.mimetype === 'image/avif'"
                loading="lazy"
            />
