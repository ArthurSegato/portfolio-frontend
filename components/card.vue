...
<template>
    <NuxtLink :to="{ path: `/projects/${id}`, hash: '#hero' }" v-motion-pop-visible-once class="group flex select-none flex-col items-center">
        <div
        ...
        >
            ...
            <video
                ...
                v-else
            >
                <source :src="url" :type="project.card.mimetype" />
            </video>
        </div>
        <div
