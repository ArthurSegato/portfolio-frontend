<template>
    <article class="prose rounded-2xl bg-base-100 p-4 shadow-lg" id="dogemaze">
        <h2>Doge Maze</h2>
        <figure>
            <video class="w-full" autoplay muted loop
                ...
                <source src="~/assets/video/dogemaze.mp4" type="video/mp4" />
            </video>
            <figcaption>
        ...
        <h3>Links</h3>
        <p>
            <NuxtLink href="https://arthursegato.itch.io/doge-maze">
                <code>Itch.io Page</code>
            </NuxtLink>
            -
            <NuxtLink href="https://github.com/ArthurSegato/DogeMaze">
