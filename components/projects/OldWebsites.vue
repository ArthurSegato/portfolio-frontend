<template>
    <article class="prose rounded-2xl bg-base-100 p-4 shadow-lg" id="oldwebsites">
        <h2>Old Websites</h2>
        <figure>
        ...
        <h3>Links</h3>
        <p>
            <NuxtLink href="https://github.com/ArthurSegato/TemplateFiverr">
                <code>TemplateFiverr</code>
            </NuxtLink>
            -
            <NuxtLink href="https://github.com/ArthurSegato/NadiaSegato">
                <code>NadiaSegato</code>
            </NuxtLink>
            -
            <NuxtLink href="https://github.com/ArthurSegato/Kafhia">
                <code>Kafhia</code>
            </NuxtLink>
            -
            <NuxtLink href="https://github.com/ArthurSegato/OldPortfolios">
