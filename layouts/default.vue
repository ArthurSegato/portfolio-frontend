<template>
    <div
        class="fixed w-full h-2 bg-red-600 sm:bg-orange-600 md:bg-yellow-600 lg:bg-green-600 xl:bg-blue-600 2xl:bg-purple-600">
    </div>
    <main
        ...
        <section class="lg:w-1/4 flex items-center justify-center p-4 border border-current m-4 rounded-xl">
            <article class="flex flex-col items-center gap-2">
                ...
                <p>computer scientist, pt-br, EU based, fullstack && game dev, hire me below.</p>
                <ul class="my-4 flex justify-evenly gap-4">
                    ...
                    <li>
                        <NuxtLink to="https://github.com/ArthurSegato/" title="Github" aria-label="Github"
                            class="group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"
                                class="group-hover:-translate-y-1 group-focus:-translate-y-1 transition-transform ease-in">
                    ...
                    <li>
                        <NuxtLink to="https://github.com/arthursegato.gpg" title="GPG Key" aria-label="GPG Key"
                            class="group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"
                                class="group-hover:-translate-y-1 group-focus:-translate-y-1 transition-transform ease-in">
