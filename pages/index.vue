...
const { isFetching, onFetchResponse, execute, onFetchError, onFetchFinally } = useFetch(
    `${runtimeConfig.public.apiBase}/contact`,
    {
        immediate: false,
    }
)
...
<template>
    ...
    >
        ...
        <section id="about" class="flex min-h-screen w-full items-center justify-center p-7">
            <div
                class="flex w-full flex-col gap-10 md:flex-row md:items-center md:gap-12 lg:w-5/6 lg:gap-24 xl:w-3/5"
            >
                <div class="flex w-full flex-col gap-6">
                    ...
                    <article class="flex flex-col gap-2 text-sm leading-normal">
                        ...
                        <p>
                            Computer Scientist graduated, with experience in game development,
                            ui/ux, full-stack development, and a love for virtual reality,
                            cybersecurity and open source!
                        </p>
                        <p>
                            Apart of technology I like to urban explore, learn about different
                            cultures, languages and talk with people from all over the world, I love
                            big and silly dogs, practice sports and take naps in cozy places, I'm a
                            fan of F1, co-op games and only know how to cook sweets.
                        </p>
                    </article>
                    <form @submit.prevent="aboutFormHanddler" autocomplete="off" class="w-full">
                        ...
                        <div class="flex">
                            <input
                                ...
                                id="command"
                                name="command"
                                placeholder="You can type some commands here..."
                ...
                <div class="flex flex-col gap-6">
                    <div class="flex items-center gap-4 md:flex-col">
                        ...
                        <ul>
                            <li class="text-2xl font-semibold text-neutral-800 dark:text-slate-200">
                                Arthur Segato Paulo
                            </li>
                            <li class="text-xl font-light text-gray-500 dark:text-slate-500">
                                ArthurSegato
                            </li>
                            <li class="text-base text-neutral-800 dark:text-slate-200">
                                just like github, right?
                            </li>
                        </ul>
                    </div>
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-2 md:flex-row">
                            ...
                            >
                                ...
                                <p class="text-sm text-zinc-800 dark:text-slate-300 md:hidden">
                                    Itch.io
                                </p>
                            </a>
                            <a
        ...
        <section id="projects" class="flex min-h-screen w-full items-center justify-center p-7">
            <div
                class="flex w-full flex-col flex-wrap content-evenly justify-evenly gap-4 md:flex-row xl:w-4/5 2xl:w-3/4"
            >
                <Card v-for="project in fetchProjectsList.data.value" :project="project" />
                <div
                    class="h-[250px] w-[350px] animate-pulse rounded-md bg-slate-300"
                    v-if="fetchProjectsList.isFetching.value"
                ></div>
                <div
                    class="h-[250px] w-[350px] animate-pulse rounded-md bg-slate-300"
                    v-if="fetchProjectsList.isFetching.value"
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex w-full">
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4 fill-[#181A1B] dark:fill-stone-100"
                                    viewBox="0 0 16 16"
                                >
                                    <path
