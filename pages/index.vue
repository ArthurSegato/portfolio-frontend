            ...
            <div class="flex w-full flex-col gap-10 md:flex-row md:items-center md:gap-12 lg:w-5/6 lg:gap-24 xl:w-3/5">
                    ...
                    <form @submit.prevent="aboutFormHanddler" autocomplete="off" class="w-full">
                        ...
                        <div class="flex">
                            ...
                            <button type="submit" :disabled="!aboutFormValidation.pass.value" class="group cursor-not-allowed rounded-r-md border-y border-r border-[#181A1B] px-3 enabled:cursor-pointer dark:border-stone-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-[#181A1B] group-disabled:fill-[#181A1B]/50 dark:fill-stone-100 dark:group-disabled:fill-stone-100/50" viewBox="0 0 16 16">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <a class="flex h-8 w-full items-center justify-center gap-2 rounded-md border border-neutral-800/20 bg-slate-50 px-4 duration-300 ease-in-out hover:bg-gray-100 active:bg-gray-200 dark:border-blue-50/20 dark:bg-zinc-800 dark:hover:bg-neutral-700 dark:active:bg-gray-800" href="https://github.com/ArthurSegato">
                            <p class="text-sm text-zinc-800 dark:text-slate-300">Follow</p>
                        </a>
                        <div class="flex flex-col gap-2 md:flex-row">
                            <a class="flex h-8 w-full min-w-[90px] items-center justify-center gap-2 rounded-md border border-neutral-800/20 bg-slate-50 px-4 duration-300 ease-in-out hover:bg-gray-100 active:bg-gray-200 dark:border-blue-50/20 dark:bg-zinc-800 dark:hover:bg-neutral-700 dark:active:bg-gray-800" href="https://arthursegato.itch.io/">
                            ...
                            <a class="flex h-8 w-full min-w-[90px] items-center justify-center gap-2 rounded-md border border-neutral-800/20 bg-slate-50 px-4 duration-300 ease-in-out hover:bg-gray-100 active:bg-gray-200 dark:border-blue-50/20 dark:bg-zinc-800 dark:hover:bg-neutral-700 dark:active:bg-gray-800" href="https://mastodon.social/@arthursegato">
                                <svg xmlns="http://www.w3.org/2000/svg" class="hidden h-4 w-4 fill-zinc-800 dark:fill-slate-300 md:inline-block" viewBox="0 0 16 16">
        ...
        <section id="contact" class="flex min-h-screen w-full items-center justify-center p-7">
            <form @submit.prevent="execute()" autocomplete="off" class="relative flex w-full flex-col gap-2 sm:w-5/6 lg:w-2/3 xl:w-1/2 2xl:w-2/5">
                <div class="flex flex-col gap-2 sm:flex-row">
                    <div class="w-full">
                        ...
                        <div class="flex w-full">
                            <input type="text" id="name" name="name" placeholder="John Doe" v-model="contactForm.name" class="h-8 w-full rounded-l-md border-y border-l border-[#181A1B] bg-transparent px-3 text-sm outline-none dark:border-stone-100" />
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex">
                            <input type="tel" id="phone" name="phone" v-maska data-maska="+## (##) #####-####" placeholder="+12 (34) 56789-1234" v-model="contactForm.phone" class="h-8 w-full rounded-l-md border-y border-l border-[#181A1B] bg-transparent px-3 text-sm outline-none dark:border-stone-100" />
                            <span class="flex items-center rounded-r-md border-y border-r border-[#181A1B] px-3 dark:border-stone-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-[#181A1B] dark:fill-stone-100" viewBox="0 0 16 16">
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="email" id="email" name="email" placeholder="your.email@here.com" v-model="contactForm.email" class="h-8 w-full rounded-l-md border-y border-l border-[#181A1B] bg-transparent px-3 text-sm outline-none dark:border-stone-100" />
                        <span class="flex items-center rounded-r-md border-y border-r border-[#181A1B] px-3 dark:border-stone-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-[#181A1B] dark:fill-stone-100" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                            </svg>
                ...
                <div>
                    ...
                    <div class="flex">
                        <textarea id="message" name="message" placeholder="Type everything you want here..." v-model="contactForm.message" class="h-52 w-full resize-y rounded-md border border-[#181A1B] bg-transparent p-3 text-sm outline-none dark:border-stone-100"></textarea>
                    </div>
                </div>
                <button type="submit" :disabled="!contactFormValidation.pass.value" class="group flex h-12 w-full cursor-not-allowed items-center justify-center rounded-md border border-[#181A1B] transition-all duration-200 ease-in-out enabled:cursor-pointer enabled:hover:border-black enabled:hover:bg-stone-200/30 disabled:border-[#181A1B]/50 dark:border-stone-100 dark:enabled:hover:border-white dark:enabled:hover:bg-stone-950/30 dark:disabled:fill-stone-100/50">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 fill-[#181A1B] group-hover:fill-black group-disabled:fill-[#181A1B]/50 dark:fill-stone-100 dark:group-hover:fill-white dark:group-disabled:fill-stone-100/50" viewBox="0 0 16 16" v-if="!isFetching">
                        <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576 6.636 10.07Zm6.787-8.201L1.591 6.602l4.339 2.76 7.494-7.493Z" />
                    </svg>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-1/3 w-1/3 fill-[#181A1B] dark:fill-stone-100" viewBox="0 0 16 16" v-if="contactButton.isSuccess">
