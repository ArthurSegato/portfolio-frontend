...
<template>
    <main :class="{ 'blur-3xl': page.blur }"
                ...
                <div class="group flex flex-col items-center" v-if="pending">
                    ...
                    <div
                        ...
                        <p class="animate-pulse text-sm leading-normal blur-sm">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt officiis tempora minima
                            dignissimos voluptatibus eligendi, libero quis mollitia voluptatum doloribus.
                        </p>
                    </div>
                </div>
                <div class="group flex flex-col items-center" v-if="pending">
        ...
        <section id="contact" class="flex w-full items-center justify-center p-7 md:p-14 lg:py-28">
            <form @submit.prevent="handleContact" v-motion-slide-visible-once-bottom autocomplete="off"
