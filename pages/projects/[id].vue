        ...
        <main id="info" class="flex w-full flex-col gap-7 p-7 md:p-12 xl:px-24 2xl:px-48">
            ...
            <ul class="flex flex-wrap justify-between gap-7 md:-order-1">
                ...
                <li class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-sm" v-if="isFinished">{{ data.youtube.views === null ? 'N/A' : new Intl.NumberFormat().format(data.youtube.views) }}</p>
                ...
                <li class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-sm" v-if="isFinished">{{ data.youtube.likes === null ? 'N/A' : new Intl.NumberFormat().format(data.youtube.likes) }}</p>
                    <span class="animate-pulse text-sm blur" v-else>0</span>
                </li>
                <li class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-sm" v-if="isFinished">{{ data.youtube.comments === null ? 'N/A' : new Intl.NumberFormat().format(data.youtube.comments) }}</p>
                    <span class="animate-pulse text-sm blur" v-else>0</span>
                </li>
            </ul>
            <ul class="flex flex-wrap justify-between gap-7">
                ...
                <li class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-sm" v-if="isFinished">{{ data.github.stars === null ? 'N/A' : new Intl.NumberFormat().format(data.github.stars) }}</p>
                    <span class="animate-pulse text-sm blur" v-else>0</span>
                </li>
            </ul>
